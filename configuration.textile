...
BigTuna can work in read--only mode allowing only to view projects and builds.  You can enable it by passing @BIGTUNA_READONLY=1@ env variable while starting server. Also, there is a configuration file where you can enable this per--environment
