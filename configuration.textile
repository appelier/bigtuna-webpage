...
* @build_passed(build)@ -- invoked when @build@ was successfully ran
* @build_fixed(build)@ -- invoked when @build@ fixed the failing project
* @build_still_fails(build)@ -- invoked when @build@ didn't fix the project
* @build_finished(build)@ -- invoked for every @build@ ran
* @build_failed(build)@ -- invoked when @build@ failed a valid project

Currently there is a @Mailer@ hook available, which allows you to send emails to specified recipients.

If you would like to contribute, check "how to write your own hook":extending.html#hook
