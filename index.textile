...
BigTuna is built on top of the Rails 3 framework. Currently it is using Postgres as a database backend, but the database schema is quite simple and there should be no problems running it e.g. on SQLite.
